...
error_reporting(0);
session_start();
if($_SESSION['id']=='') header('location:user'); 
include "act/con.php";
$no=1;
?>
<!DOCTYPE html>
...
<!--</script>-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Halaman Update User</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Form Update User</div>
					<div class="panel-body">
			            <div class="col-md-6">
			                <?php
                            $sql = "SELECT * FROM user where id='$_GET[kd]'";
                            $query = $conn->query($sql);
                            $row = $query->fetch_assoc();
                            ?>
							<form role="form" method="post" action="../act/proses_update_user.php">
								...
								<div class="form-group">
									<label>E-Mail</label>
									<input type="text" name="email" class="form-control"  value="<?php echo $row['email']?>" required <?php if($row['vEmail']==1) echo"readonly"; ?>>
								</div>
