...
<!--</script>-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Halaman Update Admin</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Form Update Admin</div>
					<div class="panel-body">
			            <div class="col-md-6">
                            ...
                            ?>
							<form role="form" method="post" action="../act/proses_update_admin.php">
							    <input name="kode" value="<?php echo $_SESSION['id']; ?>" hidden>
