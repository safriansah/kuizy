...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Halaman Leaderboard</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Tabel Nilai</div>
        ...
        while ($row = $query->fetch_assoc()) :?>
        	<tr>
        		...
        		<td><a href="updateleaderboard/<?php echo $row['id_nilai'];?>"><button type="button" class="btn btn-sm btn-warning">Update</button></a></td>
        		<td><form method="post" action="act/proses_delete_leaderboard.php"><input name="kode" hidden value="<?php echo $row['id_nilai'];?>"><button type="submit" class="btn btn-sm btn-danger">Delete</button></form></td>
        	</tr>
        <?php $no++; endwhile;?>
        </tbody>
    </table>
