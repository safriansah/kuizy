	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        while ($row = $query->fetch_assoc()) :?>
        	<tr>
        		...
        		<td><a href="updateuser/<?php echo $row['id'];?>"><button type="button" class="btn btn-sm btn-warning">Update</button></a></td>
        		<td><form method="post" action="act/proses_delete_user.php"><input name="kode" hidden value="<?php echo $row['id'];?>"><button type="submit" class="btn btn-sm btn-danger">Delete</button></form></td>
        	</tr>
        <?php $no++; endwhile;?>
        </tbody>
    </table>
