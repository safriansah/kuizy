<?php
    ...
    $botToken = "573000443:AAGAEzzodoIWn49cXj39uSIpw9JN6HDbZ64";
    ...
    if($key=="/start"){
        ...
        if($mybot->getnomor()=="0") $balasan = "Keyword tidak ada";
            ...
            if($mybot->getnomor()>$z || $waktu>120){                
                ...
                $keyboard = array(array("/start"),array("/share"));
        ...
        $q=$mybot->getidnilai($user);
        $balasan="Klik untuk share: \nhttp://kuizy.000webhostapp.com/share/$q";
    }
    else {
        $balasan = "Keyword tidak ada";
    }
    $resp = array("keyboard" => $keyboard,"resize_keyboard" => $resize,"one_time_keyboard" => false);
