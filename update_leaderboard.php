...
error_reporting(0);
session_start();
if($_SESSION['id']=='') header('location:leaderboard'); 
include "act/con.php";
$no=1;
?>
<!DOCTYPE html>
...
<!--</script>-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Halaman Update Leaderboard</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Form Update Leaderboard</div>
					<div class="panel-body">
			            <div class="col-md-6">
			                <?php
                            $sql = "SELECT * FROM nilai where id_nilai='$_GET[kd]'";
                            $query = $conn->query($sql);
                            $row = $query->fetch_assoc();
                            ?>
							<form role="form" method="post" action="../act/proses_update_leaderboard.php">
								<input name="kode" value="<?php echo $_GET['kd']; ?>" hidden>
								<div class="form-group">
									<label>ID User</label>
									<input type="text" class="form-control" name="id_user" value="<?php echo $row['id_user']?>" required readonly>
								</div>
								<div class="form-group">
									<label>ID Kategori</label>
									<input type="text" name="id_kategori" class="form-control"  value="<?php echo $row['id_kategori']?>" required readonly >
								</div>
								<div class="form-group">
									<label>Nilai</label>
								...
								<div class="form-group">
									<label>Waktu</label>
									<input type="text" name="waktu" class="form-control"  value="<?php echo $row['waktu']?>" required >
								</div>
								<div class="form-group">
									<label>Tanggal Main</label>
									<input type="datetime" name="tanggal" class="form-control"  value="<?php echo $row['tgl']?>" required >
								</div>
